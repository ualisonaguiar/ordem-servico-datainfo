...
/**
 * @ORM\Entity(repositoryClass="OrdemServico\Entity\OrdemServicoRepository")
...
class OrdemServico extends Entity
{
    ...
    static $arrSituacaoDemanda = array(
        ...
        self::CO_SITUACAO_SUSPENSO => 'Suspenso'
    );

    static $arrTypeDocuments = [
        1 => 'Ordem de Serviço',
        2 => 'Relatório de Execução',
        3 => 'Relatório Técnico',
        4 => 'Relatório do Fiscal Técnico',
    ];
    ...
    {
        $this->dt_prazo = $this->dealWithDate($strDtPrazo);
        return $this;
    }
    ...
    {
        $this->dt_emissao = $this->dealWithDate($strDtEmissao);
        return $this;
    }
    ...
    {
        $this->dt_recepcao = $this->dealWithDate($strDtRecepcao);
        return $this;
    }
    ...
    {
        return 'OS' . $this->getNuOrdemServico() . '-' . $this->getDsNome();
    }
    ...
    {
        $this->dt_alteracao = $this->dealWithDate($dt_alteracao);
        return $this;
    }

    protected function dealWithDate($strValueDate)
    {
        return Date::convertDate($strValueDate, 'Y-m-d H:i:s');
    }
}
