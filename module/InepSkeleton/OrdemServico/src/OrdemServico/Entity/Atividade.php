 ...
 * @ORM\Entity(repositoryClass="OrdemServico\Entity\AtividadeRepository")
...
class Atividade extends Entity
{
    ...
    static $arrAreaAssesoria = array(
        self::CO_ASSESSORIA_ARQUITETURA => 'ANÁLISE DE ARQUITETURA',
        self::CO_ASSESSORIA_NEGOCIO => 'ANÁLISE DE NEGÓCIO PARA SISTEMAS',
        self::CO_ASSESSORIA_NEGOCIO_ARQUITETURA => 'ANÁLISE DE ARQUITETURA DE SISTEMAS E NEGÓCIO',
    );
    ...
    /**
     * @ORM\Column(type="decimal", columnDefinition="FLOAT")
     * @var int
     */
