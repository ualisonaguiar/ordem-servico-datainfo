...
class String
{
     ...
     *
     * @example \InepZend\Util\String::beautifulProperName('INSTITUTO NACIONAL DE ESTUDOS E PESQUISAS EDUCACIONAIS ANÍSIO TEIXEIRA') <br /> \InepZend\Util\String::beautifulProperName('instituto nacional de estudos e pesquisas educacionais anísio teixeira')
     *
    ...
    {
        $strEncode = (Server::isPhpUnit()) ? 'CP850' : 'UTF-8';
     ...
     *
     * @example \InepZend\Util\String::isUTF8()
     *
     ...
     *
     * @example \InepZend\Util\String::clearWord('Ministério da Educação - Instituto Nacional de Estudos E Pesquisas Educacionais Anísio Teixeira') <br /> \InepZend\Util\String::clearWord('Ministério da Educação - Instituto Nacional de Estudos E Pesquisas Educacionais Anísio Teixeira', true)
     *
     ...
     *
     * @example \InepZend\Util\String::serialize64('INEP')
     *
     ...
     *
     * @example \InepZend\Util\String::unserialize64('czo0OiJJTkVQIjs')
     *
     ...
     * de caracteres.
     *
     * @example \InepZend\Util\String::truncate('Ministerio da Educacao')
     *
     * @param string $strValue
     ...
     *
     * @example \InepZend\Util\String::maskName('instituto nacional de estudos e pesquisas educacionais anisio teixeira')
     *
     * @param string $strName
     * @return string
     */
    public static function maskName($strName)
    {
        if (function_exists('mb_convert_encoding')) {
            if (self::isUTF8($strName))
                $strName = mb_convert_encoding($strName, (Server::isPhpUnit()) ? 'CP850' : 'UTF-8');
        } else
            $strName = self::utf8Decode($strName);
     ...
     *
     * @example \InepZend\Util\String::isNullEmpty('') <br /> \InepZend\Util\String::isNullEmpty(array())
     *
     * @param mix $mixValue
     * @return boolean
     *
     ...
     *
     * @example \InepZend\Util\String::cleanBreakline('Instituto Nacional de Estudos e Pesquisas Educacionais Anisio Teixeira')
     *
     * @param string $strValue
     * @param boolean $booBr
     ...
     *
     * @example \InepZend\Util\String::verticalText('Instituto Nacional de Estudos e Pesquisas Educacionais Anisio Teixeira') <br /> \InepZend\Util\String::verticalText('Instituto Nacional de Estudos e Pesquisas Educacionais Anisio Teixeira', true)
     *
     ...
     * desnecessarios.
     *
     * @example \InepZend\Util\String::clearText('Instituto Nacional de Estudos e Pesquisas Educacionais Anisio Teixeira')
     *
     * @param string $strText
     ...
     *
     * @example \InepZend\Util\String::replaceCharacterAndRemoveLast('MEC', array('M', 'E', 'C'), 'OAB') <br/ > \InepZend\Util\String::replaceCharacterAndRemoveLast('INEP')
     *
     * @param string $strText
     ...
     *
     * @example \InepZend\Util\String::treatingSeparatorParameter('INEP')
     *
     ...
     *
     * @example \InepZend\Util\String::substrReverse('INEP MEC', 4, 8)
     *
     * @param string $strText
     ...
     *
     * @example \InepZend\Util\String::dasherize('INEP MEC')
     *
     * @param string $strText
     ...
     *
     * @example \InepZend\Util\String::camelize('INEP MEC')
     *
     * @param string $strText
     * @return string
     *
     ...
     *
     * @example \InepZend\Util\String::substrEncode('Minstério da Educação', 5) <br /> \InepZend\Util\String::substrEncode('Minstério da Educação', 5, 21) <br /> \InepZend\Util\String::substrEncode('Minstério da Educação', 5, 'US-ASCII')
     *
     * @param string $strText
     * @param integer $intStart
     * @param integer $intLength
...
//            $strEncoding = (function_exists('mb_internal_encoding')) ? mb_internal_encoding() : 'UTF-8';
     ...
     * de UTF-8.
     *
     * @example \InepZend\Util\String::utf8Decode('&#233;rio da Educa&#231;&#227;o') <br />
     *
     * @param string $strText
     ...
     * de UTF-8.
     *
     * @example \InepZend\Util\String::utf8Encode('')
     *
     * @param string $strText
     * @param boolean $booCheck
     * @return string
     ...
     * simples e duplas.
     *
     * @example \InepZend\Util\String::listValueFromText('Inep', '<span class="Inep">Instituto Nacional de Estudos e Pesquisas Educacionais Anísio Teixeira Legislação e Documentos.</span>')
     *
     ...
     *
     * @example \InepZend\Util\String::getAlphabeticOrder()
     *
