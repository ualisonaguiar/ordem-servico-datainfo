...
class SsiServices implements AdapterInterface
{
    ...
    public function authenticate()
    {
        ...
        $booResponse = false;
        try {
            $mixResult = $this->getServiceManager()->get('InepZend\Module\Oauth\Service\SsiService')->autenticar($this->getLogin(), $this->getPass());
