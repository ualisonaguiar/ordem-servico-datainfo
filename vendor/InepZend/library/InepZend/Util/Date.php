...
/**
 * Classe responsavel no tratamento de data.
 *
 * @package InepZend
 * @subpackage Util
 */
class Date
{
     ...
     * string aaaa-mm-dd.
     *
     * @example \InepZend\Util\Date::isDateBase('2014-07-18')
     *
     * @param string $strValue
     * @return boolean
     *
     ...
     * string aaaammdd.
     *
     * @example \InepZend\Util\Date::isDateWs('20140718')
     *
     * @param string $strValue
     * @return boolean
     *
    ...
    /**
     * Verifica se a data passada como parametro esta no formato aaaa-mm-dd ou 
     * dd/mm/aaaa.
     *
     * @example \InepZend\Util\Date::isDate('18/07/2014', 'template') <br /> \InepZend\Util\Date::isDate('2014-07-18', 'base') <br /> \InepZend\Util\Date::isDate('20140718', 'ws')
     *
     * @param string $strValue
     ...
     *
     * @example \InepZend\Util\Date::getInfoDate('18/07/2014', 'template') <br /> \InepZend\Util\Date::getInfoDate('18/07/2014 18:36:15', 'template') <br /> \InepZend\Util\Date::getInfoDate('2014-07-18', 'base') <br /> \InepZend\Util\Date::getInfoDate('20140718', 'ws')
     *
     * @param string $strValue
     * @param string $strTypeDate
     * @return array
     ...
     *
     * @example \InepZend\Util\Date::getDateParse('18/07/2014', 'template') <br /> \InepZend\Util\Date::getDateParse('2014-07-18', 'base') <br /> \InepZend\Util\Date::getDateParse('20140718', 'ws')
     *
     * @param string $strValue
     * @param string $strTypeDate
     * @return array
     ...
     *
     * @example \InepZend\Util\Date::getDateFormat('18/07/2014', 'template') <br /> \InepZend\Util\Date::getDateFormat('2014-07-18', 'base') <br /> \InepZend\Util\Date::getDateFormat('20140718', 'ws')
     *
     * @param string $strValue
     * @param string $strTypeDate
     * @return array
     ...
     *
     * @example \InepZend\Util\Date::convertDateToTimestamp('18/07/2014', 'template') <br /> \InepZend\Util\Date::convertDateToTimestamp('18/07/2014 18:02:15', 'template') <br /> \InepZend\Util\Date::convertDateToTimestamp('2014-07-18', 'base') <br /> \InepZend\Util\Date::convertDateToTimestamp('2014-07-18 18:02:15', 'base') <br /> \InepZend\Util\Date::convertDateToTimestamp('20140718', 'ws') <br /> \InepZend\Util\Date::convertDateToTimestamp('20140718 18:02:15', 'ws')
     *
     * @param string $strValue
     * @return integer
     *
     ...
     *
     * @example \InepZend\Util\Date::convertDateTemplateToTimestamp('18/07/2014') <br /> \InepZend\Util\Date::convertDateTemplateToTimestamp('18/07/2014 18:45:10')
     *
     * @param string $strValue
     * @return string
     *
     ...
     *
     * @example \InepZend\Util\Date::convertDateBaseToTimestamp('2014-07-18') <br /> \InepZend\Util\Date::convertDateBaseToTimestamp('2014-07-18 18:45:10')
     *
     * @param string $strValue
     * @return string
     *
     ...
     *
     * @example \InepZend\Util\Date::convertDateWsToTimestamp('20140718') <br /> \InepZend\Util\Date::convertDateWsToTimestamp('20140718 18:45:10')
     *
     * @param string $strValue
     * @return string
     *
     ...
     * timestamp.
     *
     * @example \InepZend\Util\Date::convertDateToTimestampAction('18/07/2014') <br /> \InepZend\Util\Date::convertDateToTimestampAction('18/07/2014 18:45:10') <br /> \InepZend\Util\Date::convertDateToTimestampAction('2014-07-18') <br /> \InepZend\Util\Date::convertDateToTimestampAction('2014-07-18 18:45:10') <br /> \InepZend\Util\Date::convertDateToTimestampAction('20140718') <br /> \InepZend\Util\Date::convertDateToTimestampAction('20140718 18:45:10')
     *
     * @param string $strValue
     * @param string $strTypeDate
     * @return string
     ...
     *
     * @example \InepZend\Util\Date::convertDate('18/07/2014', 'Y-m-d') <br /> \InepZend\Util\Date::convertDate('18/07/2014 18:45:10', 'Y-m-d H:i:s') <br /> \InepZend\Util\Date::convertDate('2014-07-18', 'Y-m-d') <br /> \InepZend\Util\Date::convertDate('2014-07-18 18:45:10', 'Y-m-d H:i:s') <br /> \InepZend\Util\Date::convertDate('20140718', 'Y-m-d') <br /> \InepZend\Util\Date::convertDate('20140718 18:45:10', 'Y-m-d H:i:s')
     *
     * @param string $strValue
     ...
     * formato de data.
     *
     * @example \InepZend\Util\Date::convertDateTemplate('18/07/2014') <br /> \InepZend\Util\Date::convertDateTemplate('18/07/2014', 'd/m/Y') <br /> \InepZend\Util\Date::convertDateTemplate('18/07/2014 18:45:10', 'd/m/Y H:i:s')
     *
     * @param string $strValue
     * @param string $strFormat
     * @return string
     ...
     * formato de data.
     *
     * @example \InepZend\Util\Date::convertDateBase('2014-07-18') <br /> \InepZend\Util\Date::convertDateBase('2014-07-18', 'd/m/Y') <br /> \InepZend\Util\Date::convertDateBase('2014-07-18 18:45:10', 'd/m/Y H:i:s')
     *
     * @param string $strValue
     * @param string $strFormat
     * @return string
     ...
     * formato de data.
     *
     * @example \InepZend\Util\Date::convertDateWs('2014-07-18') <br /> \InepZend\Util\Date::convertDateWs('2014-07-18', 'd/m/Y') <br /> \InepZend\Util\Date::convertDateWs('2014-07-18 18:45:10', 'd/m/Y H:i:s')
     *
     * @param string $strValue
     * @param string $strFormat
     * @return string
     ...
     *
     * @example \InepZend\Util\Date::convertDateAction('15/07/2014') <br /> \InepZend\Util\Date::convertDateAction('15/07/2014', 'd/m/Y') <br /> \InepZend\Util\Date::convertDateAction('15/07/2014', 'template' ,'d/m/Y') <br /> \InepZend\Util\Date::convertDateAction('15/07/2014 15:50:12', 'template', 'd/m/Y H:i:s') <br /> \InepZend\Util\Date::convertDateAction('2014-07-15') <br /> \InepZend\Util\Date::convertDateAction('2014-07-15', 'd/m/Y') <br /> \InepZend\Util\Date::convertDateAction('2014-07-15', 'base' ,'d/m/Y') <br /> \InepZend\Util\Date::convertDateAction('2014-07-15 15:50:12', 'base' ,'d/m/Y H:i:s') <br /> \InepZend\Util\Date::convertDateAction('20140715') <br /> \InepZend\Util\Date::convertDateAction('20140715', 'd/m/Y') <br /> \InepZend\Util\Date::convertDateAction('20140715', 'ws' ,'d/m/Y') <br /> \InepZend\Util\Date::convertDateAction('20140715 15:50:12', 'ws' ,'d/m/Y H:i:s')
     *
     * @param string $strValue
     * @param string $strTypeDate
     * @param string $strFormat
     ...
     *
     * @example \InepZend\Util\Date::addDayToDate('15/07/2014', 2) <br /> \InepZend\Util\Date::addDayToDate('15/07/2014', 2, '-') <br /> \InepZend\Util\Date::addDayToDate('2014-07-15', 2) <br /> \InepZend\Util\Date::addDayToDate('2014-07-15', 2, '-') <br /> \InepZend\Util\Date::addDayToDate('20140715', 2) <br /> \InepZend\Util\Date::addDayToDate('20140715', 2, '-')
     *
     * @param string $strValue
     ...
     *
     * @example \InepZend\Util\Date::addHourToDate('17/07/2014 19:05:12', 2) <br /> \InepZend\Util\Date::addHourToDate('17/07/2014 19:05:12', 2, '-') <br /> \InepZend\Util\Date::addHourToDate('2014-07-15 19:05:12', 2) <br /> \InepZend\Util\Date::addHourToDate('2014-07-15 19:05:12', 2, '-') <br /> \InepZend\Util\Date::addHourToDate('20140715 19:05:12', 2) <br /> \InepZend\Util\Date::addHourToDate('20140715 19:05:12', 2, '-')
     *
     * @param string $strValue
     ...
     *
     * @example \InepZend\Util\Date::addMinuteToDate('17/07/2014 19:05:12', 2) <br /> \InepZend\Util\Date::addMinuteToDate('17/07/2014 19:05:12', 2, '-') <br /> \InepZend\Util\Date::addMinuteToDate('2014-07-15 19:05:12', 2) <br /> \InepZend\Util\Date::addMinuteToDate('2014-07-15 19:05:12', 2, '-') <br /> \InepZend\Util\Date::addMinuteToDate('20140715 19:05:12', 2) <br /> \InepZend\Util\Date::addMinuteToDate('20140715 19:05:12', 2, '-')
     *
     * @param string $strValue
     ...
     *
     * @example \InepZend\Util\Date::alterDate('18/07/2014', 1) <br /> \InepZend\Util\Date::alterDate('18/07/2014', 1, '-') <br /> \InepZend\Util\Date::alterDate('18/07/2014 11:08:10', 1, null, 'hour') <br /> \InepZend\Util\Date::alterDate('18/07/2014 11:08:10', 1, '-', 'hour')
     *
     * @param string $strValue
     ...
     *
     * @example \InepZend\Util\Date::dateDiff('23/07/2014', '25/07/2014')
     *
    ...
    public static function dateDiff($strDate1 = null, $strDate2 = null, $booRound = true, $booDiffDay = true)
    {
        ...
        if (is_null($intTimestamp2))
            return;
        $intTimestampDiff = ($intTimestamp1 > $intTimestamp2) ? ($intTimestamp1 - $intTimestamp2) : ($intTimestamp2 - $intTimestamp1);
        $intReturn = ($booDiffDay === false) ? $intTimestampDiff : ($intTimestampDiff / (60 * 60 * 24));
        if ($booRound !== false)
            $intReturn = round($intReturn);
        return $intReturn;
    }
     ...
     *
     * @example \InepZend\Util\Date::compareDates('23/07/2014', '25/07/2014') <br /> \InepZend\Util\Date::compareDates('23/07/2014 14:25:26', '25/07/2014 14:25:27')
     *
     * @param string $strInicialDate
     * @param string $strFinalDate
     * @return boolean
     *
     * @assert ('23/07/2014', '25/07/2014') === true
     * @assert ('23/07/2014', '24/07/2014') === true
     *
     * @assert ('23/07/2014 14:25:26', '25/07/2014 14:25:27') === true
     * @assert ('23/07/2014 14:25:26', '24/07/2014 14:25:23') === true
     */
    public static function compareDates($strInicialDate = null, $strFinalDate = null)
    {
        if ((is_null($strInicialDate)) || (is_null($strFinalDate)))
            return;
        $intTimestampInicialDate = self::convertDateToTimestamp($strInicialDate);
        if (is_null($intTimestampInicialDate))
            return;
        $intTimestampFinalDate = self::convertDateToTimestamp($strFinalDate);
        if (is_null($intTimestampFinalDate))
            return;
        return ($intTimestampInicialDate <= $intTimestampFinalDate);
    }
     ...
     * de semana.
     *
     * @example \InepZend\Util\Date::nextDayNotWeekend('26/07/2014') <br /> \InepZend\Util\Date::nextDayNotWeekend('2014-07-26') <br /> \InepZend\Util\Date::nextDayNotWeekend('20140726')
     *
     ...
     *
     * @example \InepZend\Util\Date::getWeekday(1) <br /> \InepZend\Util\Date::getWeekday(1, true)
     *
     ...
     *
     * @example \InepZend\Util\Date::getPortugueseMonth(1) <br /> \InepZend\Util\Date::getPortugueseMonth(1, true)
     *
     ...
     *
     * @example \InepZend\Util\Date::listDatesOfPeriod('18/07/2014', '25/07/2014')
     *
     * @param string strDate1
     * @param string strDate2
     * @return array
