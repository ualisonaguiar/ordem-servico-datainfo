...
class TranslateFunction extends FunctionNode
{
    ...
    {
        return 'TRANSLATE(' . $this->field->dispatch($sqlWalker) . ', ' . $this->expressionFind->dispatch($sqlWalker) . ', ' . $this->expressionReplace->dispatch($sqlWalker) . ')';
    }
