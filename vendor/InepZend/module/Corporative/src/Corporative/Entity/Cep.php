 ...
 * Cep
 *
 * @ORM\Table(name="CORP.TB_CEP")
 * @ORM\Entity(repositoryClass="InepZend\Module\Corporative\Entity\CepRepository")
 */
class Cep extends Entity
{
    /**
     * @var string
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="TB_CEP_CO_CEP_seq", allocationSize=1, initialValue=1)
     */
    protected $coCep;
