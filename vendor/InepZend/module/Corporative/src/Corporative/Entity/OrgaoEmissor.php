 ...
 * OrgaoEmissor
 *
 * @ORM\Table(name="CORP.TB_ORGAO_EMISSOR")
 * @ORM\Entity(repositoryClass="InepZend\Module\Corporative\Entity\OrgaoEmissorRepository")
 */
class OrgaoEmissor extends Entity
{
     ...
     * @var string
     *
     * @ORM\Column(name="SG_ORGAO_EMISSOR", type="string", length=10, nullable=true)
     */
