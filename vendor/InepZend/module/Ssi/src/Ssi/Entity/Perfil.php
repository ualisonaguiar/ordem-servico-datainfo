 ...
 * Perfil
 *
 * @ORM\Table(name="SSI.TB_PERFIL")
 * @ORM\Entity(repositoryClass="InepZend\Module\Ssi\Entity\PerfilRepository")
 */
class Perfil extends Entity
{
     ...
     * @ORM\SequenceGenerator(sequenceName="TB_PERFIL_ID_PERFIL_seq", allocationSize=1, initialValue=1)
     */
    private $idPerfil;
