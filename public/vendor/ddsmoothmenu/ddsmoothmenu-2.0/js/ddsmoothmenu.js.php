...
//arrowimages: {down:['downarrowclass', strGlobalBasePath + '/vendor/ddsmoothmenu/ddsmoothmenu-2.0/images/down.gif', 23], right:['rightarrowclass', strGlobalBasePath + '/vendor/ddsmoothmenu/ddsmoothmenu-2.0/images/right.gif', 6]},
arrowimages: {down:['downarrowclass', '', 23], right:['rightarrowclass', strGlobalBasePath + '/vendor/ddsmoothmenu/ddsmoothmenu-2.0/images/right.gif', 6]},
...
//                        if (existFunction('showMenuInepZend'))
//                            showMenuInepZend();
			return false;
		};
