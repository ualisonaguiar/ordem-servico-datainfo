...
/* # - Cor base */
/* #FFFFFF - Background */
/* #D9B0B0 - Fundo da tela de login */
/* #7C3C3C - Utilizado nos titulos e subtitulos das paginas, hiperlinks, label, botoes, breadcrumb, flexigrid, formulario, bordas de formulario, formulario e caixa de dialogo */
/* #7C3C3C - Utilizado no texto breadcrumb final */
/* #7C3C3C - Utilizado na borda do botao info */
/* #7C3C3C - Bordas e fundos dos botões quando esta com os eventos hover e focus */
/* #7C3C3C - Cor dos hiperlinks quando esta com os eventos focus e hover */
/* #F3F3F3 - Fundo do menu e submenu */
/* #D9B0B0 - Fundo dos botoes */
/* #D9B0B0 - Itens ativos do menu, cabecalho das tabelas, caixas de dialogos e flexigrid */
/* #D9B0B0 - Borda da caixa vazada e fieldset */
/* #FFFFFF - Fundo conteudo */
/* #D9B0B0 - Bordas dos elementos hmtl de texto, textarea, select, radio e checkbox quando esta com o evento focus */
...
.btn-info[disabled], .btn-info.active, .btn-info:active, .btn-info:focus, .btn-info:hover, .open > .btn-info.dropdown-toggle {
    background-color: #7C3C3C !important;
    border-color: #7C3C3C !important;
}
...
.hDivBox th, .hDivBox th.sorted {
    background-color: #D9B0B0 !important;
    background: #D9B0B0 !important;
...
.flexigrid tr.trSelected td {
    color: #000000;
    background: #D9B0B0 no-repeat right top !important;
}
...
.h-form {
    background-color: #D9B0B0;
    border-bottom: 2px solid #7C3C3C;
    color: #7C3C3C;
}
...
.nav-tabs > li.active > a {
    border-color: #D9B0B0 #D9B0B0 transparent;
}

.nav-tabs > li.active > a:focus, .nav-tabs > li.active > a:hover {
    background-color: #7C3C3C;
    border-color: #7C3C3C #7C3C3C transparent;
}
...
.google-visualization-table-div-page .gradient {
    background: linear-gradient(to bottom, rgba(217, 176, 176, 1), rgba(217, 176, 176, 1), rgba(217, 176, 176, 1), rgba(217, 176, 176, 1)) repeat scroll 0 0 rgba(0, 0, 0, 0) !important;
}
