...
/* #AA3939 - Cor base */
/* #AA3939 - Background */
/* #AA3939 - Fundo da tela de login */
/* #551616 - Utilizado nos titulos e subtitulos das paginas, hiperlinks, label, botoes, breadcrumb, flexigrid, formulario, bordas de formulario, formulario e caixa de dialogo */
/* #551616 - Utilizado no texto breadcrumb final */
/* #551616 - Utilizado na borda do botao info */
/* #551616 - Bordas e fundos dos botões quando esta com os eventos hover e focus */
/* #551616 - Cor dos hiperlinks quando esta com os eventos focus e hover */
/* #634C4C - Fundo do menu e submenu */
/* #634C4C - Fundo dos botoes */
/* #634C4C - Itens ativos do menu, cabecalho das tabelas, caixas de dialogos e flexigrid */
/* #634C4C - Borda da caixa vazada e fieldset */
...
.btn-info[disabled], .btn-info.active, .btn-info:active, .btn-info:focus, .btn-info:hover, .open > .btn-info.dropdown-toggle {
    ...
    border-color: #551616 !important;
}

.ui-button {
    border-color: #551616 !important;
    background: #634C4C !important;
}
...
.hDivBox th, .hDivBox th.sorted {
    background-color: #634C4C !important;
    background: #634C4C !important;
    color: #FFFFFF !important;
}
...
.flexigrid tr.trSelected td {
    color: #FFFFFF;
    background: #634C4C no-repeat right top !important;
}
...
.flexigrid {
    border: 1px solid #634C4C !important;
}
...
.h-form {
    background-color: #634C4C;
    border-bottom: 2px solid #551616;
    color: #FFFFFF;
}
...
.nav-tabs > li.active > a {
    border-color: #634C4C #634C4C transparent;
}
...
.table > thead > tr > th {
    border-bottom: 2px solid #634C4C;
}

.table > tbody+tbody {
    border-top: 2px solid #634C4C;
}
...
.google-visualization-table-div-page .gradient {
    background: linear-gradient(to bottom, rgba(99, 76, 76, 1), rgba(99, 76, 76, 1), rgba(99, 76, 76, 1), rgba(99, 76, 76, 1)) repeat scroll 0 0 rgba(0, 0, 0, 0) !important;
}
